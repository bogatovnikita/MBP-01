...
class Apps @Inject constructor(
    ...
    override suspend fun setNotificationDisabled(packageName: String, switched: Boolean) = db.setSwitched(packageName, switched) // TODO не понятно, что именно переключено
